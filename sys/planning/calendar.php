...
if ($selectProfil->profil_default_reservation != NULL) {
   echo '<script type="text/javascript" defer> const valueProfilDefault = ' . $selectProfil->profil_default_reservation . '</script>';
}
?>
            ...
            <script>
               ...
               function returnNumberReservationPart2(dateCalendar) {
                  ...
                  if (dateCalendar != "") {
                     ...
                     xhrPart2.open("POST", "./sys/calendar/calendar_get.php", true)
               ...
               function insertData2(int, dateSelect, partSelect, emailUser, hoursSelect) {
                  ...
                  if (int != "") {
                     ...
                     xhr2.open("POST", "./sys/calendar/calendar_post.php", true)
               ...
               // console.log(valueProfilDefault)
               ...
               if (buttonCalendarPart1) {
                  buttonCalendarPart1.forEach(element => {
                     element.addEventListener('click', (event) => {
                        ...
                        button2.remove()
                        if (typeof valueProfilDefault != 'undefined') {
                           inputNumber.value = valueProfilDefault
                        }
               ...
               button.addEventListener('click', (event) => {
                  ...
                  if (inputNumber.value > numberReservation1) {
                     ...
                     if (typeof emailSession != 'undefined') {
