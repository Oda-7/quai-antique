<?php
$namePage = "Quai Antique - S'inscrire";
...
if (!empty($_POST)) {
   ...
   if (!preg_match('/^(?=.*\d.*\d)[A-Za-z0-9._-]{12,}$/', $_POST['password'])) {
      $errors['password'] = "Le mot de passe ne comporte pas 12 caractère et au minimum 2 caractères numérique";
   ...
   if (empty($errors)) {
      ...
      try {
         ...
         $mailBody = "Merci de cliquer sur le lien ci-dessous pour confirmer votre compte <br>$url/confirm.php?id=$userId&token=$token";
         //Server settings   
...
<div class="mx-4 mt-5 pt-2">
   ...
   <div class="d-flex flex-column align-items-center gap-2">
      ...
      <form action="" method="post" class="d-flex flex-column gap-2">
         ...
         <label class="text-center">Le mot de passe doit contenir<br>12 caractère au total et 2 chiffres minimum</label>
